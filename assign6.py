...
########################################################
# Filename: assign6.py
# Author: Ashley Chen (SNO: 12330043)
# Created Date: 2016/11/06/
# Describe: 
#
########################################################
...
def maybe_download(filename, expected_bytes):
    ...
    if statinfo.st_size == expected_bytes:
        ...
        raise Exception('Failed to verify ' + filename + '. Can you get to\
                        it with a browser?')
    return filename
...
class BatchGenerator(object):
    ...
    def _next_batch(self):
        """Generate a single batch from the current cursor position\
            in the data."""
    ...
    def next(self):
        """Generate the next array of batches from the data. The array consists\
            of the last batch of the previous array, followed by num_unrollings\
            new ones."""
                                                                      ...
                                                                      train_inputs:
                                                                              ...
                                                                              lstm_cell(i,
                                                                                  ...
                                                                                  outputs.append(output)
                                                                                    ...
                                                                                    # unrollings.
                                                                                      with
                                                                                      tf.control_dependencies([saved_output.assign(output),
                                                                                                                                               saved_state.assign(state)]):
                                                                                              # Classifier.
                                                                                                  logits
                                                                                                  =
                                                                                                  tf.nn.xw_plus_b(tf.concat(0,
                                                                                                  outputs),
                                                                                                                  w,
                                                                                                                  b)
                                                                                                      loss
                                                                                                                                  ...
                                                                                                                                  tf.placeholder(tf.float32,
                                                                                                                                    ...
                                                                                                                                    tf.Variable(tf.zeros([1,
                                                                                                                                      ...
                                                                                                                                      tf.Variable(tf.zeros([1,
                                                                                                                                        ...
                                                                                                                                        =
                                                                                                                                        tf.group(
                                                                                                                                                saved_sample_output.assign(tf.zeros([1,
                                                                                                                                                                                     num_nodes])),
                                                                                                                                                saved_sample_state.assign(tf.zeros([1,
                                                                                                                                                                                    num_nodes])))
                                                                                                                                          sample_output,
                                                                                                                                          sample_state
                                                                                                                                          =
                                                                                                                                          lstm_cell(
                                                                                                                                              ...
                                                                                                                                              saved_sample_state)
                                                                                                                                            with
                                                                                                                                            tf.control_dependencies([saved_sample_output.assign(sample_output),
                                                                                                                                                                                                     saved_sample_state.assign(sample_state)]):
                                                                                                                                                    sample_prediction
                                                                                                                                                    =
                                                                                                                                                    tf.nn.softmax(tf.nn.xw_plus_b(sample_output,
                                                                                                                                                                                  w,
                                                                                                                                                                                  b))
